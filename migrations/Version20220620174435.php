 ...
 */
final class Version20220620174435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pista ADD coordenadas INT DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE equipo CHANGE nombre nombre VARCHAR(25) NOT NULL');
        $this->addSql('ALTER TABLE jugador CHANGE nombre nombre VARCHAR(30) NOT NULL, CHANGE apellidos apellidos VARCHAR(70) NOT NULL');
        $this->addSql('ALTER TABLE pista DROP coordenadas');
    }
}
