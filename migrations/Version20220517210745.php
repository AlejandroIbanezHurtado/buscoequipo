 ...
 */
final class Version20220517210745 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE torneo_partido ADD tipo VARCHAR(50) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE torneo_partido DROP tipo');
