 ...
 */
final class Version20220516223139 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jugador ADD alertas INT DEFAULT NULL');
    }
